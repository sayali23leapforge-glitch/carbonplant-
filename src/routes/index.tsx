...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "CarbonSmart Solutions Africa — Climate Tech & Regenerative Innovation" },
      { name: "description", content: "Verified climate solutions empowering African communities, restoring ecosystems, and building sustainable economic growth through carbon markets and regenerative agriculture." },
...
function Nav() {
  ...
  const links = [
    ["About", "#about"], ["Services", "#services"], ["Impact", "#impact"],
    ["Technology", "#technology"], ["Campaign", "#campaign"], ["Investors", "#investors"],
  ] as const;
  return (
    <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${scrolled ? "py-3" : "py-5"}`}>
      <div className={`mx-auto max-w-7xl px-5 sm:px-8`}>
        <div className={`flex items-center justify-between rounded-full px-5 py-2.5 transition-all duration-500 ${scrolled ? "glass shadow-[0_8px_32px_rgba(11,61,46,0.08)] border border-black/5" : "bg-transparent"}`}>
          <a href="#top" className="flex items-center gap-2.5">
            ...
            <span className="font-semibold tracking-tight text-[var(--forest)]">CarbonSmart<span className="text-[var(--emerald)]">.</span></span>
          </a>
          <nav className="hidden items-center gap-1 lg:flex">
            {links.map(([l, h]) => (
              <a key={l} href={h} className="rounded-full px-3.5 py-1.5 text-sm text-[var(--forest)]/80 transition-all duration-300 hover:bg-white hover:text-[var(--forest)] hover:shadow-[0_4px_18px_rgba(11,61,46,0.10)]">{l}</a>
            ))}
          </nav>
          <div className="hidden lg:block">
            <a href="#campaign" className="group inline-flex items-center gap-1.5 rounded-full bg-[var(--forest)] px-4 py-2 text-sm font-medium text-white transition hover:bg-[var(--emerald)]">
              Join the Movement <ArrowRight className="h-3.5 w-3.5 transition group-hover:translate-x-0.5" />
            </a>
          </div>
        ...
        {open && (
          <div className="mt-2 rounded-2xl glass border border-black/5 p-4 lg:hidden">
            <div className="flex flex-col gap-3">
              ...
              <a href="#campaign" onClick={() => setOpen(false)} className="mt-2 inline-flex items-center justify-center rounded-full bg-[var(--forest)] px-4 py-2 text-sm font-medium text-white">Join the Movement</a>
            </div>
          </div>
        )}
      </div>
...
function Hero() {
  return (
    <section id="top" className="relative min-h-[100svh] w-full overflow-hidden text-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#06241B]/85 via-[#0B3D2E]/65 to-[#0B3D2E]/95" />
      <div className="absolute inset-0 bg-[radial-gradient(60%_60%_at_50%_0%,rgba(31,122,89,0.25),transparent_60%)]" />
      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-center px-5 pt-32 pb-28 sm:px-8">
        <div className="max-w-4xl">
          ...
          <Reveal delay={120}>
            <h1 className="mt-6 text-balance text-4xl font-semibold leading-[1.05] sm:text-6xl lg:text-7xl">
              ...
              <span className="bg-gradient-to-r from-[#9ED9B7] via-white to-[#E8D9B7] bg-clip-text text-transparent">carbon markets</span>{" "}
              & regenerative innovation.
            </h1>
          </Reveal>
          <Reveal delay={240}>
            <p className="mt-7 max-w-2xl text-balance text-lg text-white/80 sm:text-xl">
        ...
        <div className="pointer-events-none absolute inset-0 hidden lg:block">
          ...
          <FloatingMetric className="right-4 bottom-44" icon={ShieldCheck} label="MRV Verified" value="ESG-Grade A" delay={2.4} />
        </div>
        ...
        <Reveal className="relative">
          <div className="relative overflow-hidden rounded-[2rem] shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6 right-6 rounded-2xl glass-dark border border-white/15 px-5 py-4 text-white">
              <p className="text-sm italic leading-snug">"Take care of the soil, so the soil will take care of you."</p>
              <p className="mt-2 text-[11px] uppercase tracking-[0.2em] text-white/70">— Wendile Mpofu, Founder</p>
            </div>
          </div>
          <div className="pointer-events-none absolute -right-6 -top-6 hidden h-24 w-24 rounded-full bg-[var(--emerald)]/20 blur-2xl sm:block" />
        </Reveal>

        <div>
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-[var(--forest)]/15 bg-[var(--beige)] px-3.5 py-1.5 text-[11px] uppercase tracking-[0.22em] text-[var(--forest)]">
              <span className="h-1.5 w-1.5 rounded-full bg-[var(--emerald)]" /> Our Story
            </span>
          </Reveal>
          <Reveal delay={120}>
            <h2 className="mt-5 text-balance text-3xl font-semibold leading-tight text-[var(--forest)] sm:text-5xl">
              Born from soil. Built for the planet.
            </h2>
          </Reveal>
          <Reveal delay={220}>
            <p className="mt-6 text-[var(--forest)]/75">
              CarbonSmart Solutions Africa was founded by <span className="font-medium text-[var(--forest)]">Wendile Mpofu</span>, a climate
              entrepreneur whose journey began in the red earth fields of her childhood. She watched generations of farmers fight depleting
              soils, unpredictable rains and rising costs — yet hold the line with quiet expertise.
            </p>
          </Reveal>
          <Reveal delay={300}>
            <p className="mt-4 text-[var(--forest)]/75">
              CSSA exists to honour that expertise with the tools of modern climate science: verified carbon credits, biochar restoration,
              regenerative agriculture and digital MRV — engineered for African landscapes, owned by African communities.
            </p>
          </Reveal>

          <div className="mt-10 grid gap-5 sm:grid-cols-2">
            {[
              { y: "2022", t: "Founded", d: "Vision set in Johannesburg." },
              { y: "2023", t: "First Cohort", d: "120 farmers onboarded." },
              { y: "2024", t: "Verified MRV", d: "Digital monitoring scales." },
              { y: "2025", t: "450+ Farmers", d: "Multi-country expansion." },
            ].map((m, i) => (
              <Reveal key={m.y} delay={400 + i * 80}>
...
const SERVICES = [
  { icon: Leaf, title: "Carbon Credit Development", desc: "End-to-end origination, certification and trading of verified African carbon credits.", bullets: ["Verra & Gold Standard", "Project origination", "Credit issuance & trading"] },
  { icon: Sprout, title: "Biochar & Soil Rehabilitation", desc: "Locking carbon in soils while restoring fertility on degraded farmland.", bullets: ["Carbon sequestration", "Soil microbiome boost", "Drought resilience"] },
  { icon: Wheat, title: "Regenerative Agriculture", desc: "Climate-smart practices proven to lift yields and resilience across smallholders.", bullets: ["Cover cropping", "No-till systems", "Agroforestry"] },
  { icon: BarChart3, title: "Climate & ESG Consulting", desc: "Strategy, disclosure and net-zero roadmaps for African corporates and partners.", bullets: ["TCFD & ISSB", "Net-zero strategy", "Materiality assessments"] },
  { icon: Globe2, title: "Multi-Pathway Climate Projects", desc: "Reforestation, blue carbon and energy access — engineered for measurable impact.", bullets: ["Reforestation at scale", "Blue carbon", "Clean cooking"] },
  { icon: Satellite, title: "Digital MRV & Verification", desc: "Satellite, sensor and AI-powered monitoring, reporting and verification at scale.", bullets: ["Satellite imagery", "IoT field sensors", "AI carbon models"] },
];

function ServiceFlipCard({ s, i }: { s: typeof SERVICES[number]; i: number }) {
  return (
    <Reveal delay={i * 80}>
      <div className="group perspective h-72">
        <div className="flip-card relative h-full w-full">
          ...
          <div className="backface-hidden absolute inset-0 overflow-hidden rounded-3xl border border-[var(--forest)]/10 bg-white p-7 shadow-sm">
            ...
            <div className="relative flex h-full flex-col">
              <span className="inline-grid h-12 w-12 place-items-center rounded-2xl bg-[var(--forest)] text-white shadow-md">
                <s.icon className="h-5 w-5" strokeWidth={2} />
              </span>
              <h3 className="mt-6 text-xl font-semibold text-[var(--forest)]">{s.title}</h3>
              <p className="mt-3 text-sm leading-relaxed text-[var(--forest)]/65">{s.desc}</p>
              <div className="mt-auto flex items-center justify-between pt-5">
                <span className="text-xs uppercase tracking-[0.2em] text-[var(--forest)]/40">0{i + 1}</span>
                <span className="text-xs uppercase tracking-[0.2em] text-[var(--emerald)]">Hover →</span>
              </div>
            </div>
          </div>
          {/* Back */}
          <div className="backface-hidden rotate-y-180 absolute inset-0 overflow-hidden rounded-3xl bg-gradient-to-br from-[var(--forest)] to-[#082A20] p-7 text-white shadow-2xl">
            <div className="pointer-events-none absolute -left-16 -bottom-16 h-56 w-56 rounded-full bg-[var(--emerald)]/30 blur-3xl" />
            <div className="relative flex h-full flex-col">
              <div className="text-xs uppercase tracking-[0.22em] text-[var(--emerald)]">{s.title}</div>
              ...
              <a href="#" className="mt-auto inline-flex items-center gap-1.5 text-sm font-medium text-white transition hover:gap-2.5">
  ...
  return (
    <section id="services" className="relative overflow-hidden bg-gradient-to-b from-[var(--beige)]/40 to-[var(--background)] py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <SectionHeader
          eyebrow="What We Do"
          title="Premium climate solutions, end-to-end."
      ...
      <div className="relative h-32 w-32">
        <svg viewBox="0 0 100 100" className="h-full w-full -rotate-90">
          ...
          <circle
            ...
            style={{ filter: "drop-shadow(0 0 8px rgba(31,122,89,0.6))" }}
          />
        </svg>
...
function Impact() {
  return (
    <section id="impact" className="relative bg-[var(--forest)] py-28 text-white sm:py-36">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(50%_60%_at_50%_0%,rgba(31,122,89,0.45),transparent_70%)]" />
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3.5 py-1.5 text-[11px] uppercase tracking-[0.22em] text-white/80">
          ...
          <Reveal delay={200}>
            <p className="mt-4 text-white/70">Numbers audited through digital MRV — soil to satellite to ledger.</p>
          </Reveal>
        </div>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Reveal key={s.l} delay={i * 100}>
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-7 backdrop-blur transition hover:bg-white/[0.07]">
        ...
        <Reveal delay={300}>
          <div className="mt-12 grid gap-8 rounded-3xl border border-white/10 bg-white/[0.04] p-8 backdrop-blur sm:grid-cols-3 sm:gap-12 sm:p-12">
            <Ring pct={40} label="Yield Increase" />
            <Ring pct={30} label="Fertilizer Reduction" />
    ...
    <section id="technology" className="relative overflow-hidden bg-[var(--background)] py-28 sm:py-36">
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:gap-20">
        <div>
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-[var(--forest)]/15 bg-[var(--beige)] px-3.5 py-1.5 text-[11px] uppercase tracking-[0.22em] text-[var(--forest)]">
              <span className="h-1.5 w-1.5 rounded-full bg-[var(--emerald)]" /> Technology
            </span>
          </Reveal>
          <Reveal delay={120}>
          ...
          <Reveal delay={220}>
            <p className="mt-5 text-[var(--forest)]/70">
              A digital MRV stack that fuses satellite imagery, on-the-ground sensors and AI models to deliver
              verifiable, investor-grade climate data — in real time.
            </p>
          </Reveal>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-[var(--forest)]/10 shadow-2xl">
              ...
              <div className="absolute left-5 top-5 right-5 sm:left-6 sm:top-6 sm:right-auto sm:w-[320px] rounded-2xl glass border border-white/40 p-4 shadow-xl">
                <div className="flex items-center justify-between">
                  <div className="text-[11px] uppercase tracking-[0.18em] text-[var(--forest)]/70">Live MRV</div>
...
const TESTIMONIALS = [
  ...
  { q: "The MRV dashboard turned our work into data investors could trust. Funding followed.", a: "Amara Diallo", r: "Project Manager · Senegal" },
          ...
          {TESTIMONIALS.map((t, i) => (
            <div key={i} className="min-w-0 flex-[0_0_100%] sm:flex-[0_0_50%] lg:flex-[0_0_33.333%]">
              <div className="group relative h-full overflow-hidden rounded-3xl border border-[var(--forest)]/10 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
                <Quote className="h-8 w-8 text-[var(--emerald)]/30" />
        ...
        <Reveal>
          <div className="relative mt-16 overflow-hidden rounded-3xl shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <div className="text-[11px] uppercase tracking-[0.22em] text-white/70">Featured Story</div>
              <h3 className="mt-2 max-w-2xl text-balance text-2xl font-semibold sm:text-4xl">From depleted to thriving — in two seasons.</h3>
              <p className="mt-3 max-w-xl text-white/80">A cooperative of 60 farmers in Limpopo restored 240 hectares with biochar and regenerative practice.</p>
            </div>
          </div>
        </Reveal>
...
function Campaign() {
  return (
    <section id="campaign" className="relative overflow-hidden py-28 text-white sm:py-36">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#06241B]/95 via-[#0B3D2E]/85 to-[#0B3D2E]/70" />
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 sm:px-8 lg:grid-cols-2">
        <div>
          ...
          <Reveal delay={220}>
            <p className="mt-5 max-w-xl text-white/80 sm:text-lg">One seedling. One farmer. One community at a time.</p>
          </Reveal>
          <Reveal delay={320}>
        ...
        <Reveal delay={200}>
          <div className="rounded-3xl border border-white/15 glass-dark p-7 sm:p-8">
            <div className="text-[11px] uppercase tracking-[0.22em] text-white/65">Your Impact</div>
            ...
            <div className="mt-6 h-2 overflow-hidden rounded-full bg-white/10">
              <div className="h-full w-[64%] rounded-full bg-gradient-to-r from-[var(--emerald)] to-[#9ED9B7]" />
            </div>
    ...
    <section id="investors" className="relative bg-[var(--background)] py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid items-end gap-10 lg:grid-cols-2">
          ...
          <Reveal delay={200}>
            <p className="text-[var(--forest)]/70 lg:text-lg">
        ...
        <Reveal delay={300}>
          <div className="mt-14 overflow-hidden rounded-3xl border border-[var(--forest)]/10 bg-gradient-to-br from-[var(--forest)] to-[#082A20] p-10 text-white sm:p-14">
            <div className="grid items-center gap-8 lg:grid-cols-[1.4fr_1fr]">
              <div>
                ...
                <p className="mt-3 max-w-xl text-white/75">Co-design portfolios, sponsor projects, or integrate verified credits into your net-zero pathway.</p>
              </div>
...
function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#06241B] text-white/80">
      <div className="absolute inset-0 bg-[radial-gradient(50%_60%_at_50%_0%,rgba(31,122,89,0.18),transparent_70%)]" />
      <div className="relative mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <a href="#top" className="flex items-center gap-2.5">
              <span className="grid h-9 w-9 place-items-center rounded-full bg-[var(--emerald)] text-white">
            ...
            <div className="mt-6 flex items-center gap-3">
              {[Instagram, Linkedin, Facebook].map((I, i) => (
                <a key={i} href="#" className="grid h-10 w-10 place-items-center rounded-full border border-white/15 transition hover:bg-white/10 hover:text-white">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {["ESG-Aligned", "Verra Ready", "Gold Standard", "TCFD"].map((b) => (
                <span key={b} className="rounded-full border border-white/15 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.18em] text-white/70">{b}</span>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm">
              {["About", "Services", "Impact", "Technology", "Investors"].map((l) => (
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-8 sm:flex-row sm:items-center">
          <p className="text-xs text-white/55">© {new Date().getFullYear()} CarbonSmart Solutions Africa. All rights reserved.</p>
          <p className="text-xs text-white/55">Committed to a net-positive Africa by 2040.</p>
        </div>
      </div>
    </footer>
  );
...
const GALLERY = [
  ...
  { src: galleryTech, t: "Climate Tech in the Field", d: "Live MRV dashboards beside growing plants.", span: "h-[260px]" },
